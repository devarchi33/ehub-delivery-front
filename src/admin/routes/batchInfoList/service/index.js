...
export const insertBatchIfo = (createdBatchInfo) => {
    return BatchRequestEntity("PUT", `${BASE_URL}/batchInfoList`, "insertBatchIfo", createdBatchInfo);
};

export const deleteBatchIfo = (key) => {
    return BatchRequestEntity("DELETE", `${BASE_URL}/batchInfoList?batchName=${key.batchName}&jobName=${key.jobName}`, "insertBatchIfo");
};
...
export const forceExecuteJob = (jobName, selectedBrandCodeList, selectedPlatformCodeList, endClosingDt) => {
    return executeJob(jobName, selectedBrandCodeList, selectedPlatformCodeList, endClosingDt, true);
};